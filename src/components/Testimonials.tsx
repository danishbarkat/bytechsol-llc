...
const testimonials = [
  {
    id: 1,
    quote: "Agency transformed our digital presence with their AI-driven approach. The results exceeded all expectations, and their team's expertise in machine learning was invaluable.",
    author: "Sarah Chen",
    role: "CTO, TechCorp",
  ...
  {
    id: 2,
    quote: "Working with this team was a game-changer. They didn't just build a product—they created an experience that our users love. The attention to detail is remarkable.",
  ...
  {
    id: 3,
    quote: "The level of innovation and technical expertise is unmatched. They took our complex requirements and delivered a solution that was both elegant and powerful.",
