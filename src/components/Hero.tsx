...
const orbitSizes: { [key: number]: number } = {
  1: 220,
  2: 340,
  3: 460,
};
  ...
  return (
    <section className="relative overflow-hidden w-full" style={{ height: '920px' }}>
      ...
      <motion.div
        ...
        className={`absolute inset-0 backdrop-blur-2xl border-0 transition-colors duration-300 ${theme === 'dark'
          ? 'bg-white/5'
          : 'bg-white/40'
          }`}
      >
          ...
          <div className="w-full flex items-center justify-between gap-12">
            ...
            <div className="max-w-2xl">
              ...
              >
                ...
                <span className={`block transition-colors ${theme === 'dark' ? 'text-purple-400' : 'text-purple-600'
                  }`}>
              ...
              >
                We engineer Odoo ERP systems, production-ready AI agents, high-performance web/mobile platforms,
                and 'Search-Everywhere' SEO strategies that drive measurable ROI for modern enterprises.
              </motion.p>
              ...
              >
                <a
                  href="#contact"
                  className={`group inline-flex items-center justify-center gap-3 px-8 py-4 text-white transition-all ${theme === 'dark'
                ...
                <a
                  href="#services"
                  className={`inline-flex items-center justify-center px-8 py-4 backdrop-blur-xl transition-all ${theme === 'dark'
            ...
            <div className="flex-shrink-0" style={{ marginLeft: '-10px' }}>
              <div className="relative" style={{ width: '600px', height: '600px' }}>
                ...
                {[1, 2, 3].map((orbit) => (
                  <motion.div
                    key={`orbit-${orbit}`}
                    className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full ${theme === 'dark'
                ...
                <motion.div
                  className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full backdrop-blur-xl border-4 shadow-2xl flex items-center justify-center ${theme === 'dark'
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          {/* Name */}
                          <span
                            className={`text-xs whitespace-nowrap transition-colors backdrop-blur-sm px-2 py-1 rounded ${theme === 'dark' ? 'text-white bg-black/20' : 'text-slate-900 bg-white/30'
                              }`}
                            style={{
      ...
      >
        <motion.div
          ...
          className={`w-6 h-10 border flex items-start justify-center p-2 backdrop-blur-xl ${theme === 'dark' ? 'border-slate-700 bg-white/5' : 'border-slate-300 bg-white/30'
            }`}
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-30">
        {[...Array(20)].map((_, i) => (
          <motion.div
            key={i}
            className={`absolute w-1 h-1 rounded-full ${theme === 'dark' ? 'bg-purple-400/30' : 'bg-purple-500/20'
              }`}
            initial={{
